...
import { DEFAULT_PAGE, DEFAULT_PAGE_ITEMS_PER_PAGE } from '~/utils/constants'
...
function Boards() {
  ...
  useEffect(() => {
    ...
    // uselocation của react-router-dom cũng thay đổi theo, đòng nghĩa hàm useEffect sẽ chạy lại và fetch lại API
    // theo đúng page mới ví cái localtion.search đã nằm trong dependencies của useEffect
            ...
            {(totalBoards > 0) &&
              <Box sx={{ my: 3, pr: 5, display: 'flex', alignItems: 'center', justifyContent: 'flex-end' }}>
                <Pagination
                  ...
                  count={Math.ceil(totalBoards / DEFAULT_PAGE_ITEMS_PER_PAGE)}
