...
function InviteBoardUser({ boardId }) {
  ...
  */
  ...
  const submitInviteUserToBoard = (data) => {
    ...
    // Gọi Api mới một người dùng nào đó vào làm thành viên của board
    InviteUserToBoardAPI({ inviteeEmail, boardId }).then(() => {

      // Clear thẻ input sử dụng react-hook-form bằng setValue, đồng thời đóng cái popover lại
      setValue('inviteeEmail', null)
      setAnchorPopoverElement(null)

      // Mời mọt người dùng vào board xong thì cũng sẽ gửi/email sự kiện socket lên server (tính năng real-time)
    })
    ...
    <Box>
      <Tooltip title="Invite user to this board!">
        <Button
          ...
          sx={{ color: 'white', borderColor: 'white', '&:hover': { borderColor: 'white' }, height: '36px' }}
        >
          Invite
        </Button>
      </Tooltip>
