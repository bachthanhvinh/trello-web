        ...
        <Typography sx={{ fontSize: '18px !important', lineHeight: '25px', fontWeight: 400, maxWidth: '350px', textAlign: 'center' }}>
          ...
          <Typography variant="span" sx={{
            ...
            '&:after': {
              position: 'absolute',
              content: '""',
              borderBottom: '3px solid #f53f2bff',
              left: 0,
              top: '43%',
              width: '100%'
            }
          ...
          &nbsp;<Typography variant="span" sx={{ color: '#2bc9f5ff', fontWeight: 500 }}>VinDev</Typography>?<br />Hmm, looks like that page doesn&apos;t exist.
        </Typography>
        ...
        <Link to="/" style={{ textDecoration: 'none' }}>
          <Button
            ...
            sx={{
              ...
              color: 'white',
              borderColor: 'white',
              '&:hover': { color: '#2bc9f5ff', borderColor: '#2bc9f5ff' }
            }}
          >Go Home</Button>
        </Link>
      </Box>
