    ...
    columns: [
      {
        ...
        cardOrderIds: ['card-id-07', 'card-id-04', 'card-id-03', 'card-id-02', 'card-id-05', 'card-id-06', 'card-id-01'],
        cards: [
          {
            _id: 'card-id-01',
            boardId: 'board-id-01',
      ...
      },
      {
        ...
        // Cấu trúc Id của cái card này để Unique chỉ cần đặt một cái tên placeholder-card vì mỗi cái chỉ có 1 cái tên này
        // Quang trọng khi tạo: phải đẩy đủ: {_id, boardId, column, FE_PlaceholderCard}
